...
void usage (unsigned short _error)
{
	...
	fprintf(stderr, "\n\t--qdepends           depends on one of targets");
	fprintf(stderr, "\n\t--qconflicts         conflicts with one of targets");
	fprintf(stderr, "\n\t--qprovides          provides one of targets");
	fprintf(stderr, "\n\t--qreplaces          replaces one of targets");
	fprintf(stderr, "\n\t--qrequires          required by one of targets");
	fprintf(stderr, "\n\t-s --search          search");
